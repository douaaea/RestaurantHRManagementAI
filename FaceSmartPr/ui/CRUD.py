...
"}")
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(710, 120, 281, 41))
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/icons/select.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/icons/search.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icons/clear.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/icons/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
